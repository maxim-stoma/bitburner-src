...
[Главная](./index.md) &gt; [bitburner](./bitburner.md) &gt; [CodingContractSignatures](./bitburner.codingcontractsignatures.md)
...
"Subarray with Maximum Sum": [number[], number]
```
Для контракта "Subarray with Maximum Sum" тип входных данных — `number[]`, а тип ответа — `number`<!-- -->.
